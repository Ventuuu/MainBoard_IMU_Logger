...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3|BLE_P0_0_Pin|BLE_P3_6_Pin|GPIO_PIN_8
  ...
  /*Configure GPIO pins : PC3 BLE_P0_0_Pin BLE_P3_6_Pin PC8
                           BLE_RESET_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|BLE_P0_0_Pin|BLE_P3_6_Pin|GPIO_PIN_8
                          |BLE_RESET_Pin;
